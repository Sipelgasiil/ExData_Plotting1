...
#-4 Reconstructing plot 1 using base plotting system

##-4A Reconstructing a red frequency histogram of the household's global minute-averaged active
## power consumption 
with(SubData, hist(Global_active_power, main = "Global Active Power",
     xlab = "Global Active Power (kilowatts)", col = "red"))
##-4B Copying the histogram to PNG file called 'plot1.png' with a width of 480 pixels and
